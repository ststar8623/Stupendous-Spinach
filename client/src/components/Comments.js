...
//                <li className="comments-li" key={i}> <img src={photo} className="comments-icon"/> <span className="comments-profile">{ firstName }</span><span className="comments-text">{ comment.text }</span></li>
